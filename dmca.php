        ...
        <nav class="navbar bg-dark navbar-expand-md">
            <div class="container-fluid">
                ...
                <div id="menuNavbar" class="mt-2 collapse navbar-collapse">
                    ...
                    <a href="dmca.php" class="nav-link text-light border">DMCA</a>
            ...
            <div class="col-12 col-lg-8 m-0">
                ...
                <main class="w-100">
                    <div class="container border my-5 p-2">
                        <h1>DMCA</h1>
                        <span class="negrito">lsl4k1997@gmail.com</span>
                        <br>
                        <div>O site <span class="negrito">Magrão Games</span> é apenas um agregador de links, e assim
                            como o google.com, apenas agrega e organiza os links externos. Os arquivos que estão
                            publicados não estão armazenados no nosso servidor, não somos responsável por nenhum arquivo
                            disponibilizados na web. Todo e qualquer link P2P (Torrent) é criado por usuários e
                            disponibilizados na web, apenas encontramos esses links e agregamos ao Site! Não somos
                            responsáveis pelos arquivos e links aqui encontrados. Os Arquivos Multi são todos de Sites
                            externos e tragos até o site como forma alternativa de download. Obrigado pela compreensão.
                        </div>
                    </div>
                </main>
            </div>
        ...
        <div class="container">
            ...
            <div class="row py-3">
                ...
                <div class="col-12 col-md-4 text-center">
                    ...
                    <img src="imagens-index/logo-nova-transparente.png"
                    alt="logo/site" style="width: 100px;">
                    </a>
                </div>
                <div class="col-12 col-md-4 text-center">
